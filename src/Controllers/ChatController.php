...
class ChatController {
    ...
    public function heartbeat(): void {
        ...
        $currentCheckTime = $input['last_update_check'] ?? 0;
        ...
        while (time() - $startTime < $timeout) {
            ...
            if ($lastUpdate > $currentCheckTime || $lastKnownMicrotime == 0) {
                ...
                // If no messages found, don't re-query until another file change occurs
                $currentCheckTime = $lastUpdate;
            }
